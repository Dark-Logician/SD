...
class Enemy_3:
    ...
    def __init__(self, direction, position, velocity, health, state):
        ...
        barrel_4 = line_gen(self.position, 32, move = (0,-8))
        hull_I_4 = rect_gen(self.position, 1, 5, move = (- 9, - 1))
        hull_II_4 = rect_gen(self.position, 1, 5, move = (- 4, + 1))
        hull_III_4 = rect_gen(self.position, 1, 5, move = (4, + 1))
        hull_IV_4 = rect_gen(self.position, 1, 5, move = (9, - 1))
        self.body = Body([barrel_4, hull_I_4, hull_II_4, hull_III_4, hull_IV_4], self.direction, self.position)
